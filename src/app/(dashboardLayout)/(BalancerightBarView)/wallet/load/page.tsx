import LoadForm from '@/components/form/moredealsclub/wallet/load/LoadForm'
  ...
  return (
      ...
      <Card className="w-full ">
        <CardHeader className=''>
          <CardTitle className='flex items-center border-b border-primary dark:border-gray-200'><Image src={'/images/svg/load_amount.svg'} alt={"load"} className=" h-8 w-auto mb-3 rounded-full object-cover" width={100} height={100} />Load Money</CardTitle>
        </CardHeader>
        <CardContent >
