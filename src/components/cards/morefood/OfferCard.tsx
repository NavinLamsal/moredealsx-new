      ...
      <div className="bg-green-300 rounded-lg  w-96 shadow-lg">
        <div className="flex items-center">
          <div className="flex-1 p-4 rounded-l-lg bg-green-500">
            ...
            <h2 className="text-sm text-black mt-1 line-clamp-1">
              {offer.description}
            </h2>
            <p className="text-sm text-black mt-1">
              Ends: {moment(offer.end_date).format("ddd, MM/D,")}. Terms apply
            </p>
            <div className="flex flex-1 items-center gap-2 mt-3">
              <button
                className=" bg-white text-black font-semibold py-2 px-4 rounded-full shadow-md hover:bg-gray-100 hidden lg:block"
                onClick={() => handleViewDetails("dialog")}
              >
                Order now
              </button>
              <button
                className=" bg-white text-black font-semibold py-2 px-4 rounded-full shadow-md hover:bg-gray-100 block lg:hidden"
