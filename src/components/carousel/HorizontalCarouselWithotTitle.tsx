...
const HorizontalCarouselWithOutTitle: React.FC<HorizontalCarouselWithOutTitleProps> = ({ title, viewAll, children }) => {
  ...
  return (
    <div className="w-full">
      ...
      {/* </div> */}
      <div ref={scrollRef} className="flex flex-nowrap py-1 space-x-4 overflow-x-auto overflow-y-hidden 
