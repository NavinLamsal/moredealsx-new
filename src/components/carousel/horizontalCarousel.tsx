    ...
    <div className="w-full">
      {!center && center ? (
        ...
        <>
          <div
            className={`flex ${
              dashboard ? "justify-start" : "justify-center"
            }  items-center mb-2 relative`}
          >
            {dashboard ? (
            ...
            <div className="hidden md:flex absolute right-0 top-0">
              ...
              {viewAll && (
                <Link
                  href={viewAll}
                  className="text-foreground dark:text-primary  hover:underline mt-2 ml-2"
                >
                  View All
                </Link>
              )}
      ...
      <div
        ref={scrollRef}
        className="flex flex-nowrap py-4 space-x-4 overflow-x-auto overflow-y-hidden 
