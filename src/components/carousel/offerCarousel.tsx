...
{(price !== null && price !== 0) &&
  <div className="absolute bottom-14 right-6 bg-gradient-to-l from-red-600 to-red-500 text-white px-2 py-1 md:px-3 md:py-2 font-bold w-12 h-12 md:w-20 md:h-20 flex flex-col justify-center items-center shadow-md custom-clip z-30 rounded-tr-2xl md:rounded-tr-3xl rounded-bl-2xl md:rounded-bl-3xl  md:hidden">
    ...
    {/* {(discount_percentage !== null && Number(discount_percentage) > 0) &&
      <div className="absolute top-0 right-6 custom-ribbon flex flex-col items-center justify-center text-white font-bold w-20 h-24 text-center z-30">
        <div className="text-sm md:text-base xl:text-lg leading-none">-{discount_percentage}%</div>
        <div className="text-xs xl:text-sm">off</div>
      </div>
    }
    ...
    {(discount_amount !== null && Number(discount_amount) > 0) &&
      ...
      <div className="absolute bottom-14 right-6 bg-gradient-to-l from-red-600 to-red-500 text-white px-3 py-2 font-bold w-20 h-20 flex flex-col justify-center items-center shadow-md custom-clip z-30 rounded-tr-3xl rounded-bl-3xl">
        <span className="text-sm md:text-base xl:text-xl leading-tight ">{currency_symbol}{discount_amount}</span>
