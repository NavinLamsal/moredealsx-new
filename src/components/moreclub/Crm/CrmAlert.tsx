...
const CrmAlert = () => {
  ...
  if (isLoading) {
    return <div className="w-full bg-yellow-100 border border-yellow-300 rounded-xl shadow p-4 flex flex-col gap-3 animate-pulse">
      <div className="w-32 h-4 bg-yellow-300 rounded" />
      <div className="w-48 h-3 bg-yellow-200 rounded" />
      <div className="flex gap-3 justify-end">
        <div className="w-16 h-8 bg-yellow-300 rounded-md" />
        <div className="w-16 h-8 bg-yellow-300 rounded-md" />
      </div>
    </div>;
  }
