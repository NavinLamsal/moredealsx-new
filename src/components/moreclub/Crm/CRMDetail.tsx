...
export default function CRMDetail() {
  ...
  return (
    <div>
      ...
      <p className='text-muted-foreground'>Set up your CRM by providing essential information to personalize your experience and make communication seamless. Your domain, login email, and phone number help us create a secure and customized space for your team and clients.</p>
