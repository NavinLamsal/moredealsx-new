...
interface AutoCompleteInputProps {
    handleManualInputChange: (event: ChangeEvent<HTMLInputElement>, field: keyof Address) => void;
...
export default function AutoCompleteInput({ handleManualInputChange, setAddress, streetAndNumber }: AutoCompleteInputProps) {
    ...
    const handleSuggestionClick = (suggestion: any) => {
        ...
        const newAddress: Address = { address, city, street, zip_code, region, house_no };
