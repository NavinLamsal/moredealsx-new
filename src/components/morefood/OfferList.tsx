...
const OfferList = ({ type, searchParams }: { type: string, searchParams: { [key: string]: string | string[] | undefined } }) => {
    ...
    const {
        ...
        queryFn: ({ pageParam = 1 }) => fetchAllOfferList(type, { ...searchParams, city_name: city }, pageParam),
