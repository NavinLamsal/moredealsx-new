...
const FeaturedRestaurants = () => {
  ...
  const { fetchRestaurantList} = useFetchRestaurant()
   const { data, error, isLoading } = useQuery({
     ...
     queryFn: () => fetchRestaurantList("featured/list" ,{city_code: city}, 1) ,
     staleTime: 60000,
     enabled: !!city
   });
  ...
  return (
    <div className="p-1 lg:p-4">
      <HorizontalCarousel title="Featured Restaurants" viewAll={`/morefood/category/featured?title=Featured Restaurants`}>
