...
import HotelCard from "./cards/HotelCard2";
...
const Hotels = () => {
  ...
  return (
    <div className=" p-1 lg:p-4">
      <HorizontalCarousel center={true} title="Featured Hotels" viewAll="/moreliving/category/featured-hotel?title=Featured Hotels">
