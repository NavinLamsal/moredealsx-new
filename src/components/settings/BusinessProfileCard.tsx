...
import { Clock, Mail, MapPin, Phone, Sparkle, Sparkles } from "lucide-react";
        ...
        >
          ...
          <div className="col-span-8 space-y-1 text-sm md:text-base">
            ...
            <div className="flex items-baseline gap-4">
              ...
              {(!user?.membership?.membership_code ||
                user?.membership?.membership_code.toLowerCase() === "free") && (
                <Link
                  href={"/settings/upgrade"}
                  className="bg-white flex items-center gap-1 border hover:border-black/70 shadow shadow-gray-500 text-black px-4 py-1 rounded text-sm cursor-pointer font-medium"
                >
                  Upgrade{" "}
                  <Image
                    src={"/images/svg/sparkles.svg"}
                    alt="sparkles"
                    width={100}
                    height={100}
                    className="w-8 h-7"
            ...
            <p className="my-3">
              ...
              {business?.businessProfile?.business_registration_number ?? "N/A"}
            </p>
