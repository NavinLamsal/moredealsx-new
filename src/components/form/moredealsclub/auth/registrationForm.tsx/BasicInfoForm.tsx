...
const BasicInfoForm = () => {
  ...
  const handlePhoneNumberChange = async (data: any) => {
  ...
  const validate = async (
    ...
    if ("firstName" in fieldValues) {
      tempErrors.firstName = validateRequired(
    ...
    if ("lastName" in fieldValues) {
      tempErrors.lastName = validateRequired(
    ...
    if ("registerMethod" in fieldValues) {
      tempErrors.registerMethod =
        fieldValues.registerMethod === "" ? "Choose any one Method" : "";
    }
    ...
    <>
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 p-2">
        ...
        <div>
          ...
          <RadioGroup
            defaultValue={registerMethod}
            className="grid grid-cols-2 gap-4"
            onValueChange={(value) => handleChange("registerMethod", value)}
          >
            <div>
              <RadioGroupItem
                value="EMAIL"
          ...
          {errors.registerMethod && (
            <p className="text-red-500 text-sm">{errors.registerMethod}</p>
          )}
        </div>
