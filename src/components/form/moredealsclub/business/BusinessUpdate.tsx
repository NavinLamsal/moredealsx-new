...
export default function BusinessPage({ userdata }: { userdata: any }) {
  const searchParams = useSearchParams()
  const tab = searchParams.get("tab")
  const sidebarNavItems = [
    { title: "General Information", component: <BasicInfoForm businessData={userdata} /> },
    { title: "Documents", component: <BusinessDocumentsUploadForm businessData={userdata} /> },
    // { title: "Business Types", component: <BusinessTypes /> },
  ];
